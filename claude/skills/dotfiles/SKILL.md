...
This backs up any existing real dotfiles, creates the symlinks from `/Users/Shared`, and clones
powerlevel10k if missing. Then: install Claude Code (native installer) and log in; if the prompt isn't
...
- powerlevel10k is gitignored (a dependency). Update it with `git -C /Users/Shared/dotfiles/zsh/powerlevel10k pull`.
